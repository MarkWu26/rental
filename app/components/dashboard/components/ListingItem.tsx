...
const ListingItem: React.FC<ListingItemProps> = ({
    ...
    const {id, title, status, totalReservations, price, totalEarnings} = listing;
  ...
  return (
    <div className="flex flex-row w-full text-neutral-500 text-sm items-center">
        ...
        <div className="w-[30%] text-xs flex flex-row items-center">
            <div className="bg-indigo-100 text-indigo-500 font-bold rounded-md px-2 py-1">
