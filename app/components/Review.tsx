  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col ">
        {isUserReview && (
          <div className="font-semibold  text-lg pb-4">Your review</div>
        )}
        <div className="flex flex-row gap-3">
          {/* Avatar */}
          <div>
            <Avatar src={review.user?.image} isReview />
          </div>
          ...
          <div className="flex flex-col w-full">
                ...
                <div className="">
                  <MdOutlineModeEditOutline
                    ...
                    className="
                        ...
                        "
                    onClick={() =>
                      reviewModal.onOpen(ratingValue, comment, true, review.id)
                    }
                  />
                </div>
              )}
            ...
            <div className="justify-start flex flex-row">
              <ReviewInput isReview value={review.ratingValue} />
            </div>
            <div className="text-xs mt-1 text-neutral-600">{formattedDate}</div>
